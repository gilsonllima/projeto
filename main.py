# codigo para captura de movimento espacial com calculo do desvio padrap
...
while True:
    ...
    for (i, rect) in enumerate(rects):
        ...
        dist_coeffs = np.zeros((4, 1))  # assumindo que nao ha distorcao da lente
        ...
        cv2.line(image, (int(image_points[0][0]), int(image_points[0][1])), (int(image_points[2][0]), int(image_points[2][1])), (255, 51, 255), 2)
        cv2.line(image, (int(image_points[0][0]), int(image_points[0][1])), (int(image_points[3][0]), int(image_points[3][1])), (255, 51, 255), 2)
        cv2.line(image, (int(image_points[2][0]), int(image_points[2][1])), (int(image_points[3][0]), int(image_points[3][1])), (255, 51, 255), 2)
        cv2.line(image, (int(image_points[2][0]), int(image_points[2][1])), (int(image_points[4][0]), int(image_points[4][1])), (255, 51, 255), 2)
        cv2.line(image, (int(image_points[3][0]), int(image_points[3][1])), (int(image_points[5][0]), int(image_points[5][1])), (255, 51, 255), 2)
        cv2.line(image, (int(image_points[4][0]), int(image_points[4][1])), (int(image_points[1][0]), int(image_points[1][1])), (255, 51, 255), 2)
        cv2.line(image, (int(image_points[5][0]), int(image_points[5][1])), (int(image_points[1][0]), int(image_points[1][1])), (255, 51, 255), 2)
        cv2.line(image, (int(image_points[4][0]), int(image_points[4][1])), (int(image_points[5][0]), int(image_points[5][1])), (255, 51, 255), 2)
        cv2.line(image, (int(image_points[4][0]), int(image_points[4][1])), (int(image_points[0][0]), int(image_points[0][1])), (255, 51, 255), 2)
        cv2.line(image, (int(image_points[5][0]), int(image_points[5][1])), (int(image_points[0][0]), int(image_points[0][1])), (255, 51, 255), 2)
        cv2.line(image, (int(image_points[0][0]), int(image_points[0][1])), (int(image_points[1][0]), int(image_points[1][1])), (255, 51, 255), 2)
